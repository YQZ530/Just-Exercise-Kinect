...
{
    public float CamX = 100f;
    public float CamY = 100f;
		...
		if(kinectInitialized)
		{
			   ...
			   (computeUserMap != UserMapType.None && computeUserMap != UserMapType.RawUserDepth))
	        {
				if(usersMapRect.width == 0 || usersMapRect.height == 0)
				{
					...
					usersMapRect = new Rect(cameraRect.width - displayWidth+ CamX, cameraRect.height+ CamY, displayWidth, -displayHeight);
                    print("usersMap rect is zero");
                    print((cameraRect.width - displayWidth) + " " + (cameraRect.height) + " " + displayWidth + "  " + -displayHeight);
                }
			...
			else if(computeColorMap && displayColorMap)
			{
				if(usersClrRect.width == 0 || usersClrRect.height == 0)
				{
					...
					usersClrRect = new Rect(cameraRect.width - displayWidth, cameraRect.height-200f, displayWidth, -displayHeight);
